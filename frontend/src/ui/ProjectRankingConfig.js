...
export default function ProjectRankingConfig({ projectId, criteria: initialCriteria }) {
  ...
  const handleSave = () => {
    // Aqui você enviaria os critérios com os pesos atualizados para o backend
    console.log('Critérios salvos para o projeto', projectId, criteria);
    alert('Pesos salvos! O backend irá recalcular o ranking.');
  };
